...
| `customer_note`      | `text`         | Free-text note from the client (step 3 of the booking form) |
| `service_description` | `text`        | What the client asked for on a custom (`other`) quote |
| `admin_notes`        | `text`         |                                     |
